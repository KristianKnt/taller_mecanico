<!--
    Codigo hecho de afan y mucho sacrificio  :D
-->
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Login - <?php include('dist/includes/title.php');?></title>
    ...
    <title>REPARATION GENERAL MOTORS</title>
    <!-- meta tags -->
    <meta charset="UTF-8" />
...
<body>
    <center>
    <h2 style="color:white;">Repation General Motors</h2>
    </center>
    ...
    <form action="login.php" method="post">
            ...
            <div class="forgot">
                <a href="https://www.facebook.com/profile.php?id=100069674072657"  >Mas info por aca</a>
                <p><input type="checkbox">Recordar password</p>
            </div>
            <button type="submit" name="login">Login</button>
        </form>
        <p class=" w3l-register-p">Visita mi pagina web <a href="https://www.instagram.com/tallermecanico.alvarez/" class="register" target="_blank">  aqui</a></p>
    </div>
    <footer>
