          ...
          <div class="box-body">
            ...
            ?>
              ...
              <form class="form-horizontal" method="post" action="empresa_actualizar.php" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                  <label class="control-label col-lg-3" for="price">Nit</label><br>
                  <div class="col-lg-9">
                ...
                <!-- podemos quitar esta funcion  para que no salga en la edicion de la empresa-->
                <div class="form-group">
                  <label class="control-label col-lg-3" for="name">Porcentaje impuesto </label>
                  <div class="col-lg-9">

                    <textarea class="form-control" id="impuesto" name="impuesto" required><?php echo $row['impuesto']; ?></textarea>
                  </div>
                </div>
