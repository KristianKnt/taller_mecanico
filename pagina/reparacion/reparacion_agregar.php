...
if ($caja_cont==0) {
    ...
    $caja_query=mysqli_query($con,"select * from empresa  ")or die(mysqli_error());
    $i=0;
    while($row_caja=mysqli_fetch_array($caja_query)){
...
<br>
             ...
             <select class="form-control select2" name="id_marca" id="id_marca" required>
              ...
              $queryc=mysqli_query($con,"select * from marca  ")or die(mysqli_error());
      ...
      <option value="">-- SELECCIONE --</option>
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                       ...
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                          <input type="text" class="form-control pull-right" id="placa" name="placa" placeholder="numero comprobante" required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Codigo registro</label>
                 
                      </div><!-- /.form group -->
                    </div>
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                          <input type="text" class="form-control pull-right" id="codigo_registro" name="codigo_registro" placeholder="codigo registro" required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Fallas</label>
                 
                      </div><!-- /.form group -->
                    </div>
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                        <textarea class="form-control" id="fallas" name="fallas"></textarea>
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Que componentes se revisaran</label>
            ...
            <div class="row">
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Precio estimado</label>
                 
                      </div><!-- /.form group -->
                    </div>
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                          <input type="text" class="form-control pull-right" id="precio_estimado" name="precio_estimado" placeholder="Precio estimado" required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
