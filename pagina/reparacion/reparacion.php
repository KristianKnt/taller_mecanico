...
$auto="";
 ...
 where r.estado_reparacion='transito'")or die(mysqli_error());
    $i=0;
...
<a class="btn btn-success btn-print" href="<?php  echo "../reparacion/pos_repuestos.php?id_reparacion=$id_reparacion";?>"  target="_blank"  role="button">Repuestos</a>
...
<a class="btn btn-primary btn-print" href="<?php  echo "../reparacion/cambiar_estado.php?id_reparacion=$id_reparacion";?>"  onClick="return confirm('¿Está seguro de que quieres dar de alta vehiculo??');"  role="button">Dar de alta vehiculo</a>
      <?php
                      }
                      ?>
  ...
  if ($tipo_comprobante=="Factura") {
                      ...
                      ?>
<a class="btn btn-primary btn-print" href="<?php  echo "../reparacion/ver_reparacion.php?id_reparacion=$id_reparacion";?>"  target="_blank"  role="button">Ver/edita detalles</a>
<a class="btn btn-success btn-print" href="<?php  echo "../reparacion/pos_repuestos.php?id_reparacion=$id_reparacion";?>"  target="_blank"  role="button">Repuestos</a>
