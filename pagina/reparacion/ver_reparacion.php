...
<?php
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from reparacion r inner join marca m on m.id_marca = r.id_marca inner join modelo md on md.id_modelo = r.id_modelo inner join clientes c on c.id_cliente = r.cliente where id_reparacion= '$id_reparacion' ")or die(mysqli_error());
    $i=1;
...
?>
     ...
     <div class="row">
                   ...
                   <textarea readonly class="form-control" id="fallas" name="fallas"><?php echo $row['fallas'];?></textarea>
    ...
    <div class="row">
       ...
       <div class="row">
            ...
            <input type="text" class="form-control" id="precio_estimado"  name="precio_estimado" value="<?php echo $row['precio_estimado'];?>" required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
