...
           </div>
           <div class="col-md-3">
             <form method="post" action="../reportes/reportes_por_fecha.php" enctype="multipart/form-data" class="form-horizontal">
...
?>
 ...
 where r.estado_reparacion='reparado' and r.fecha_estimada>='$fecha_inicio' and  r.fecha_estimada<='$fecha_final'")or die(mysqli_error());
    $contador=0;
