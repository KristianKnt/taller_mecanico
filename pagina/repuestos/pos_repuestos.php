...
$empresa_query = mysqli_query($con,"select * from usuario where idempleado = '$idempleado'")or die(mysql_error());
...
<ul id="myUL">
  <?php
    ...
    $query=mysqli_query($con,"select i.fecha,i.tipo_comprobante as comprobante,
         ...
         where  i.idsucursal= $idsucursal and i.estado='A' and di.stock_actual>0 ")or die(mysqli_error());
    $i=1;
    while($row=mysqli_fetch_array($query)){
