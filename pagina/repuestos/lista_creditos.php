...
#buscar{
 ...
 <!--end of modal-->
                  ...
                  <div class="box-header">
                  <h3 class="box-title"> VENTAS A CREDITO</h3>
                </div><!-- /.box-header -->
...
<?php
   ...
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select p.*, c.nombre as Cliente, c.correo ,v.tipo_venta,v.idventa,v.total,v.tipo_comprobante 
      from venta v inner join pedido p on v.idpedido = p.idpedido inner join clientes c on p.idcliente = c.id_cliente where p.idsucursal = $idsucursal and v.tipo_venta='Credito' 
       and p.tipo_pedido = 'Venta' order by idpedido desc limit 0,2999")or die(mysqli_error());
    $i=0;
...
<a class="btn btn-primary btn-print" href="<?php  echo "../ventas/pagar_credito.php?idventa=$idventa";?>"  target="_blank"  role="button"><i class="glyphicon glyphicon-usd"></i></a>
      <?php
                      }
                      ?>
