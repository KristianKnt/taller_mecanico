...
?>
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title"> MODIFICAR MODELO</h3>
                </div><!-- /.box-header -->
...
<?php
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from modelo where id_modelo= '$id_modelo' ")or die(mysqli_error());
    $i=1;
     ...
     <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Nombre Modelo</label>
